...
execute if score #debug sg_config matches 1 run tellraw @a [{"text":"[Smart Golem Debug] ","color":"gold"},{"text":"Processing item ","color":"gray"},{"nbt":"item","storage":"smart_golem:macro_item","color":"yellow"}]
