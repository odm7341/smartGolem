$kill @e[type=marker,tag=sg_memory,distance=..1,nbt={data:{golem_uuid:$(gu)}}]
$kill @e[type=marker,tag=sg_chest,distance=..1,nbt={data:{golem_uuid:$(gu)}}]
$summon marker ~ ~ ~ {Tags:["sg_chest"], data:{golem_uuid:$(gu)}}
