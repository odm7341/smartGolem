...
data modify storage smart_golem:util gu set from @e[type=minecraft:copper_golem,sort=nearest,limit=1] UUID
tellraw @a [{"text":"[Smart Golem] ","color":"green"},{"text":"Markers for nearest golem:","color":"gray"}]
